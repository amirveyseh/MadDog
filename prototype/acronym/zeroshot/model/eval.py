...
from prototype.acronym.zeroshot.model.utils import torch_utils, scorer, constant, helper
...
p, r, f1 = scorer.score_expansion(batch.gold(), predictions, verbos=True)
